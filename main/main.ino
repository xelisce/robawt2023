...
double servos_angle[servosNum] = {0, 0, 180, 0, 130, 180}; //basic states initialised
const double servos_max_angle[servosNum] = {180, 180, 300, 180, 300, 300};
