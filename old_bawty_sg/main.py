...
def task0_lt():
    ...
    if not gs_now and not red_now and not blue_now:
        ...
        #^ supposedly accounts for the stupid gaps between tiles (hopefully works now)
        print("minigap", white_start_y - black_second_start_y)
        if white_start_y - black_second_start_y < 11 and white_start_y > 140 and black_second_start_y > 300: #? technically white_start_y > 140 is redundant but wtv
            white_start_y = white_second_start_y
            black_line_height = black_start_y - white_start_y #^ adjusts the new height so bot stops wiggling
            print("/" * 20 + "minigap detected" + "\\" * 20)
            print("new white_start_y", white_start_y)
        ...
        if ((black_start_y < 230 or white_start_y > 150) and black_line_width < 150): #or (black_second_start_y > 150 and white_second_start_y < 150):
                if black_second_start_y <= 60 and not 40 <= black_second_mask_width <= 300: #or black_start_y < 200:
                    curr = Task.LINEGAP
                ...
                print ("LINEGAP DEBUGGING: black_start_y:", black_start_y)
        ...
        #^ First condition:
        #? Force bot to move forward when encoder vals remain relatively unchanged for ~5 sec?
        if (black_start_y > 100 and white_start_y < 100 and black_line_width > 50) or (black_second_start_y > 60 and white_second_start_y < 60 and black_second_sum > 1750 and 40 < black_second_mask_width < 300): #!!! white2ndstart = 120, 80<black_second_mask_width<600
            #!! whitestarty < 165, white_2nd_start < 110, 70<black_second_width<600
            curr = Task.EMPTY
            end_line_gap = 1
            x_black_com = x_com
