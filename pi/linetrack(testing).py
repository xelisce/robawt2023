...
b_minarea = 350000 #! ~DOM: to tune the values 
...
while True:
    ...
    mask_black = mask_black_org[height-40:, :]
    ...
    # cv2.imshow("Black lt mask", mask_black)
    ...
    # # x_com_scale = ((1-y_black_com) ** 0.3)
    # y_black_com = y_black_com** 2
    # # x_black_com *= x_com_scale
    #~end commented out
    ...
    # cv2.imshow("Mask black gap", frame_org[crop_h_bw:, :][white_start_y:black_start_y, :])
    # cv2.circle(frame_org[crop_h_bw:, :], (0, white_start_y), 10, 255, 1)
    # cv2.imshow("circleee", frame_org[crop_h_bw:, :])
    # y_black_com = y_com[white_start_y:black_start_y, :]
    # x_black_com = x_com[white_start_y:black_start_y, :]
    # print("y_black", y_black_com)
    # print("x_black", x_black_com)
    # cv2.imshow('x_black_com', x_black_com)
    # cv2.imshow('y_black_com', y_black_com)
