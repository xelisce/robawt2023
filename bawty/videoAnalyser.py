...
current_frame = 0
total_frames = int(top_stream.get(cv2.CAP_PROP_FRAME_COUNT)) #! for some reason this isnt accurate at all lol idk how to fix
...
#* -----------------------------------------------------==Evac Find Ball==------------------------------------------------------------------
def task_1_ball(): #^ change all "evac_org" to "frame_org"
...
def task_2_depositalive():
    ...
    print(curr.name)
    print(to_pico)
#* -----------------------------------------==========END EVAC FIND ALIVE DEPOSIT POINT=========-------------------------------------------------------

#* ---------------------------------------------------==Evac Find Dead Deposit Point==------------------------------------------------------------------
...
#* -----------------------------------------==========END EVAC FIND DEAD DEPOSIT POINT=========-------------------------------------------------------

#* ---------------------------------------------------==After Evac Back To Linetrack==------------------------------------------------------------------
def task4_backtolt():
    global rotation, curr
    global frame_org
...
#* -----------------------------------------==========END AFTER EVAC BACK TO LINETRACK=========-------------------------------------------------------

#* -------------------------------------------==Linetrack See Line On Right When Turn left==------------------------------------------------------------------
...
#* ---------------------------------==========END LINETRACK SEE LINE ON RIGHT WHEN TURN LEFT=========-------------------------------------------------------



#* -------------------------------------------==Linetrack See Line On Left When Turn Right==------------------------------------------------------------------
...
#* ---------------------------------==========END LINETRACK SEE LINE ON LEFT WHEN TURN RIGHT=========-------------------------------------------------------


#* ------------------------------------==Diagonal Lidars Detect Extrusion; Detect Amount of Black==------------------------------------------------------------------
